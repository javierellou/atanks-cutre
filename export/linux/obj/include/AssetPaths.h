...
class HXCPP_CLASS_ATTRIBUTES AssetPaths_obj : public ::hx::Object
{
	...
	public:
		...
		static void __boot();
		static ::String titleSong__ogg;
		static ::String titleSong__wav;
		static ::String music_goes_here__txt;
		static ::String data_goes_here__txt;
		static ::String sounds_go_here__txt;
		static ::String explosion__wav;
		static ::String startButton__png;
		static ::String images_go_here__txt;
		static ::String quitButton__png;
		static ::String fondoinicio__png;
		static ::String player1__png;
		static ::String player2__png;
		static ::String explosion__png;
		static ::String sky__jpg;
		static ::String preview__png;
		static ::String titleButton__png;
		static ::String misile__png;
		static ::String Indicator__png;
