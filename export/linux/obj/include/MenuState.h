...
class HXCPP_CLASS_ATTRIBUTES MenuState_obj : public  ::flixel::FlxState_obj
{
	...
	public:
		...
		::String __ToString() const { return HX_("MenuState",d2,bf,b6,c0); }
		 ...
		 ::flixel::FlxSprite quit;
		void create();

		void onDown( ::flixel::FlxSprite button);
		::Dynamic onDown_dyn();

		void onOver( ::flixel::FlxSprite button);
		::Dynamic onOver_dyn();

		void onOut( ::flixel::FlxSprite button);
		::Dynamic onOut_dyn();

		void exitGame( ::flixel::FlxSprite button);
