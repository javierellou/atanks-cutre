...
HX_LOCAL_STACK_FRAME(_hx_pos_06b4bf51740b9656_81_renderMask,"openfl.display._internal.Context3DShape","renderMask",0xdd38c193,"openfl.display._internal.Context3DShape.renderMask","openfl/display/_internal/Context3DShape.hx",81,0x4e47a55e)
...
HXLINE(  50)				matrix->scale((( (Float)(1) ) / graphics->_hx___bitmapScaleX),(( (Float)(1) ) / graphics->_hx___bitmapScaleY));
...
HXLINE(  62)				 ::openfl::display3D::VertexBuffer3D vertexBuffer = graphics->_hx___bitmap->getVertexBuffer(context,null(),null());
HXLINE(  63)				if (::hx::IsNotNull( shader->_hx___position )) {
HXLINE(  63)					context->setVertexBufferAt(( (int)(shader->_hx___position->index) ),vertexBuffer,0,3);
            				}
HXLINE(  64)				if (::hx::IsNotNull( shader->_hx___textureCoord )) {
HXLINE(  64)					context->setVertexBufferAt(( (int)(shader->_hx___textureCoord->index) ),vertexBuffer,3,2);
            				}
HXLINE(  65)				 ::openfl::display3D::IndexBuffer3D indexBuffer = graphics->_hx___bitmap->getIndexBuffer(context,null());
HXLINE(  66)				context->drawTriangles(indexBuffer,null(),null());
HXLINE(  72)				renderer->_hx___clearShader();
            			}
...
void Context3DShape_obj::renderMask( ::openfl::display::DisplayObject shape, ::openfl::display::OpenGLRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_06b4bf51740b9656_81_renderMask)
HXLINE(  82)		 ::openfl::display::Graphics graphics = shape->_hx___graphics;
HXLINE(  84)		if (::hx::IsNotNull( graphics )) {
HXLINE(  88)			::openfl::display::_internal::Context3DGraphics_obj::renderMask(graphics,renderer);
HXLINE(  90)			if (::hx::IsNotNull( graphics->_hx___bitmap )) {
...
HXLINE(  96)				renderer->applyBitmapData(graphics->_hx___bitmap,true,null());
HXLINE(  97)				renderer->applyMatrix(renderer->_hx___getMatrix(graphics->_hx___worldTransform,1));
HXLINE(  98)				renderer->updateShader();
HXLINE( 100)				 ::openfl::display3D::VertexBuffer3D vertexBuffer = graphics->_hx___bitmap->getVertexBuffer(context,null(),null());
...
HXLINE( 103)				 ::openfl::display3D::IndexBuffer3D indexBuffer = graphics->_hx___bitmap->getIndexBuffer(context,null());
