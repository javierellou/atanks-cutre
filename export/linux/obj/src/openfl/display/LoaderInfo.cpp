...
HXLINE( 244)		this->frameRate = ((Float)-1);
...
void LoaderInfo_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(assetLibrary,"assetLibrary");
...
void LoaderInfo_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(assetLibrary,"assetLibrary");
...
::hx::Val LoaderInfo_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"assetLibrary") ) { return ::hx::Val( assetLibrary ); }
...
::hx::Val LoaderInfo_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"assetLibrary") ) { assetLibrary=inValue.Cast<  ::openfl::utils::AssetLibrary >(); return inValue; }
...
void LoaderInfo_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("assetLibrary",eb,02,c2,5f));
...
static ::hx::StorageInfo LoaderInfo_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::openfl::utils::AssetLibrary */ ,(int)offsetof(LoaderInfo_obj,assetLibrary),HX_("assetLibrary",eb,02,c2,5f)},
