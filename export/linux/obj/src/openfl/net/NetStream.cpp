...
HX_LOCAL_STACK_FRAME(_hx_pos_2d6908cd6c18c638_2134_video_onDurationChange,"openfl.net.NetStream","video_onDurationChange",0x55b3a167,"openfl.net.NetStream.video_onDurationChange","openfl/net/NetStream.hx",2134,0x9cb99312)
...
void NetStream_obj::video_onDurationChange( ::Dynamic event){
            	HX_STACKFRAME(&_hx_pos_2d6908cd6c18c638_2134_video_onDurationChange)
HXDLIN(2134)		this->_hx___playStatus(HX_("NetStream.Play.durationchange",8d,76,16,f2));
            	}


HX_DEFINE_DYNAMIC_FUNC1(NetStream_obj,video_onDurationChange,(void))
...
::hx::Val NetStream_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 22:
		...
		if (HX_FIELD_EQ(inName,"video_onDurationChange") ) { return ::hx::Val( video_onDurationChange_dyn() ); }
	}
...
static ::String NetStream_obj_sMemberFields[] = {
	...
	HX_("video_onDurationChange",e7,78,17,bd),
