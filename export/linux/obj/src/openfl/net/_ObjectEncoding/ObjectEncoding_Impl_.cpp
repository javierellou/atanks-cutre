...
HX_LOCAL_STACK_FRAME(_hx_pos_3f487fe0ddab7949_83_boot,"openfl.net._ObjectEncoding.ObjectEncoding_Impl_","boot",0xd935ef42,"openfl.net._ObjectEncoding.ObjectEncoding_Impl_.boot","openfl/net/ObjectEncoding.hx",83,0x1f8adcbb)
HX_LOCAL_STACK_FRAME(_hx_pos_3f487fe0ddab7949_90_boot,"openfl.net._ObjectEncoding.ObjectEncoding_Impl_","boot",0xd935ef42,"openfl.net._ObjectEncoding.ObjectEncoding_Impl_.boot","openfl/net/ObjectEncoding.hx",90,0x1f8adcbb)
...
HX_LOCAL_STACK_FRAME(_hx_pos_3f487fe0ddab7949_106_boot,"openfl.net._ObjectEncoding.ObjectEncoding_Impl_","boot",0xd935ef42,"openfl.net._ObjectEncoding.ObjectEncoding_Impl_.boot","openfl/net/ObjectEncoding.hx",106,0x1f8adcbb)
HX_LOCAL_STACK_FRAME(_hx_pos_3f487fe0ddab7949_117_boot,"openfl.net._ObjectEncoding.ObjectEncoding_Impl_","boot",0xd935ef42,"openfl.net._ObjectEncoding.ObjectEncoding_Impl_.boot","openfl/net/ObjectEncoding.hx",117,0x1f8adcbb)
namespace openfl{
namespace net{
...
int ObjectEncoding_Impl__obj::LARGE_HXSF;

int ObjectEncoding_Impl__obj::JSON;

int ObjectEncoding_Impl__obj::LARGE_JSON;
...
static ::hx::StaticInfo ObjectEncoding_Impl__obj_sStaticStorageInfo[] = {
	...
	{::hx::fsInt,(void *) &ObjectEncoding_Impl__obj::LARGE_HXSF,HX_("LARGE_HXSF",07,2a,8f,f9)},
	{::hx::fsInt,(void *) &ObjectEncoding_Impl__obj::JSON,HX_("JSON",28,0a,29,31)},
	{::hx::fsInt,(void *) &ObjectEncoding_Impl__obj::LARGE_JSON,HX_("LARGE_JSON",8c,c8,dd,fa)},
...
static void ObjectEncoding_Impl__obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(ObjectEncoding_Impl__obj::LARGE_HXSF,"LARGE_HXSF");
	HX_MARK_MEMBER_NAME(ObjectEncoding_Impl__obj::JSON,"JSON");
	HX_MARK_MEMBER_NAME(ObjectEncoding_Impl__obj::LARGE_JSON,"LARGE_JSON");
...
static void ObjectEncoding_Impl__obj_sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(ObjectEncoding_Impl__obj::LARGE_HXSF,"LARGE_HXSF");
	HX_VISIT_MEMBER_NAME(ObjectEncoding_Impl__obj::JSON,"JSON");
	HX_VISIT_MEMBER_NAME(ObjectEncoding_Impl__obj::LARGE_JSON,"LARGE_JSON");
...
static ::String ObjectEncoding_Impl__obj_sStaticFields[] = {
	...
	HX_("LARGE_HXSF",07,2a,8f,f9),
	HX_("JSON",28,0a,29,31),
	HX_("LARGE_JSON",8c,c8,dd,fa),
...
{
            	HX_STACKFRAME(&_hx_pos_3f487fe0ddab7949_83_boot)
HXDLIN(  83)		HXSF = 10;
            	}
{
            	HX_STACKFRAME(&_hx_pos_3f487fe0ddab7949_90_boot)
HXDLIN(  90)		LARGE_HXSF = 11;
            	}
{
...
{
            	HX_STACKFRAME(&_hx_pos_3f487fe0ddab7949_106_boot)
HXDLIN( 106)		LARGE_JSON = 13;
            	}
{
            	HX_STACKFRAME(&_hx_pos_3f487fe0ddab7949_117_boot)
HXDLIN( 117)		DEFAULT = 10;
            	}
}
