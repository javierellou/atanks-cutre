...
HX_DEFINE_STACK_FRAME(_hx_pos_c5f39c48023aa9de_272_new,"openfl.text.TextFormat","new",0xfdb2c999,"openfl.text.TextFormat.new","openfl/text/TextFormat.hx",272,0xd3329397)
HX_LOCAL_STACK_FRAME(_hx_pos_c5f39c48023aa9de_290_clone,"openfl.text.TextFormat","clone",0x965d8cd6,"openfl.text.TextFormat.clone","openfl/text/TextFormat.hx",290,0xd3329397)
HX_LOCAL_STACK_FRAME(_hx_pos_c5f39c48023aa9de_316___merge,"openfl.text.TextFormat","__merge",0x0ccb8551,"openfl.text.TextFormat.__merge","openfl/text/TextFormat.hx",316,0xd3329397)
HX_LOCAL_STACK_FRAME(_hx_pos_c5f39c48023aa9de_346___toCacheKey,"openfl.text.TextFormat","__toCacheKey",0xeadfa3df,"openfl.text.TextFormat.__toCacheKey","openfl/text/TextFormat.hx",346,0xd3329397)
HX_LOCAL_STACK_FRAME(_hx_pos_c5f39c48023aa9de_350_set_font,"openfl.text.TextFormat","set_font",0xe6ea6af3,"openfl.text.TextFormat.set_font","openfl/text/TextFormat.hx",350,0xd3329397)
HX_LOCAL_STACK_FRAME(_hx_pos_c5f39c48023aa9de_360_set_size,"openfl.text.TextFormat","set_size",0xef7dade5,"openfl.text.TextFormat.set_size","openfl/text/TextFormat.hx",360,0xd3329397)
HX_LOCAL_STACK_FRAME(_hx_pos_c5f39c48023aa9de_370_set_bold,"openfl.text.TextFormat","set_bold",0xe4458ea9,"openfl.text.TextFormat.set_bold","openfl/text/TextFormat.hx",370,0xd3329397)
HX_LOCAL_STACK_FRAME(_hx_pos_c5f39c48023aa9de_380_set_italic,"openfl.text.TextFormat","set_italic",0x5206cd14,"openfl.text.TextFormat.set_italic","openfl/text/TextFormat.hx",380,0xd3329397)
HX_LOCAL_STACK_FRAME(_hx_pos_c5f39c48023aa9de_58_boot,"openfl.text.TextFormat","boot",0xf6d69cd9,"openfl.text.TextFormat.boot","openfl/text/TextFormat.hx",58,0xd3329397)
namespace openfl{
namespace text{
...
void TextFormat_obj::__construct(::String font, ::Dynamic size, ::Dynamic color, ::Dynamic bold, ::Dynamic italic, ::Dynamic underline,::String url,::String target, ::Dynamic align, ::Dynamic leftMargin, ::Dynamic rightMargin, ::Dynamic indent, ::Dynamic leading){
            	HX_STACKFRAME(&_hx_pos_c5f39c48023aa9de_272_new)
HXLINE( 273)		this->set_font(font);
HXLINE( 274)		this->set_size(size);
HXLINE( 275)		this->color = color;
HXLINE( 276)		this->set_bold(bold);
HXLINE( 277)		this->set_italic(italic);
HXLINE( 278)		this->underline = underline;
HXLINE( 279)		this->url = url;
HXLINE( 280)		this->target = target;
HXLINE( 281)		this->align = align;
HXLINE( 282)		this->leftMargin = leftMargin;
HXLINE( 283)		this->rightMargin = rightMargin;
HXLINE( 284)		this->indent = indent;
HXLINE( 285)		this->leading = leading;
            	}
...
bool TextFormat_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::text::TextFormat TextFormat_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_c5f39c48023aa9de_290_clone)
HXLINE( 291)		 ::openfl::text::TextFormat newFormat =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,this->font,this->size,this->color,this->bold,this->italic,this->underline,this->url,this->target,null(),null(),null(),null(),null());
HXLINE( 293)		newFormat->align = this->align;
HXLINE( 294)		newFormat->leftMargin = this->leftMargin;
HXLINE( 295)		newFormat->rightMargin = this->rightMargin;
HXLINE( 296)		newFormat->indent = this->indent;
HXLINE( 297)		newFormat->leading = this->leading;
HXLINE( 299)		newFormat->blockIndent = this->blockIndent;
HXLINE( 300)		newFormat->bullet = this->bullet;
HXLINE( 301)		newFormat->kerning = this->kerning;
HXLINE( 302)		newFormat->letterSpacing = this->letterSpacing;
HXLINE( 303)		newFormat->tabStops = this->tabStops;
HXLINE( 305)		newFormat->strikethrough = this->strikethrough;
HXLINE( 307)		newFormat->_hx___ascent = this->_hx___ascent;
HXLINE( 308)		newFormat->_hx___descent = this->_hx___descent;
HXLINE( 310)		newFormat->_hx___cacheKey = this->_hx___toCacheKey();
HXLINE( 312)		return newFormat;
            	}
...
void TextFormat_obj::_hx___merge( ::openfl::text::TextFormat format){
            	HX_STACKFRAME(&_hx_pos_c5f39c48023aa9de_316___merge)
HXLINE( 317)		if (::hx::IsNotNull( format->font )) {
HXLINE( 317)			this->set_font(format->font);
            		}
HXLINE( 318)		if (::hx::IsNotNull( format->size )) {
HXLINE( 318)			this->set_size(format->size);
            		}
HXLINE( 319)		if (::hx::IsNotNull( format->color )) {
HXLINE( 319)			this->color = format->color;
            		}
HXLINE( 320)		if (::hx::IsNotNull( format->bold )) {
HXLINE( 320)			this->set_bold(format->bold);
            		}
HXLINE( 321)		if (::hx::IsNotNull( format->italic )) {
HXLINE( 321)			this->set_italic(format->italic);
            		}
HXLINE( 322)		if (::hx::IsNotNull( format->underline )) {
HXLINE( 322)			this->underline = format->underline;
            		}
HXLINE( 323)		if (::hx::IsNotNull( format->url )) {
HXLINE( 323)			this->url = format->url;
            		}
HXLINE( 324)		if (::hx::IsNotNull( format->target )) {
HXLINE( 324)			this->target = format->target;
            		}
HXLINE( 325)		if (::hx::IsNotNull( format->align )) {
HXLINE( 325)			this->align = format->align;
            		}
HXLINE( 326)		if (::hx::IsNotNull( format->leftMargin )) {
HXLINE( 326)			this->leftMargin = format->leftMargin;
            		}
HXLINE( 327)		if (::hx::IsNotNull( format->rightMargin )) {
HXLINE( 327)			this->rightMargin = format->rightMargin;
            		}
HXLINE( 328)		if (::hx::IsNotNull( format->indent )) {
HXLINE( 328)			this->indent = format->indent;
            		}
HXLINE( 329)		if (::hx::IsNotNull( format->leading )) {
HXLINE( 329)			this->leading = format->leading;
            		}
HXLINE( 330)		if (::hx::IsNotNull( format->blockIndent )) {
HXLINE( 330)			this->blockIndent = format->blockIndent;
            		}
HXLINE( 331)		if (::hx::IsNotNull( format->bullet )) {
HXLINE( 331)			this->bullet = format->bullet;
            		}
HXLINE( 332)		if (::hx::IsNotNull( format->kerning )) {
HXLINE( 332)			this->kerning = format->kerning;
            		}
HXLINE( 333)		if (::hx::IsNotNull( format->letterSpacing )) {
HXLINE( 333)			this->letterSpacing = format->letterSpacing;
            		}
HXLINE( 334)		if (::hx::IsNotNull( format->tabStops )) {
HXLINE( 334)			this->tabStops = format->tabStops;
            		}
HXLINE( 336)		if (::hx::IsNotNull( format->strikethrough )) {
HXLINE( 336)			this->strikethrough = format->strikethrough;
            		}
HXLINE( 338)		if (::hx::IsNotNull( format->_hx___ascent )) {
HXLINE( 338)			this->_hx___ascent = format->_hx___ascent;
            		}
HXLINE( 339)		if (::hx::IsNotNull( format->_hx___descent )) {
HXLINE( 339)			this->_hx___descent = format->_hx___descent;
            		}
HXLINE( 341)		this->_hx___toCacheKey();
            	}
...
::String TextFormat_obj::_hx___toCacheKey(){
            	HX_STACKFRAME(&_hx_pos_c5f39c48023aa9de_346___toCacheKey)
HXDLIN( 346)		::String _hx_tmp = ((HX_("",00,00,00,00) + this->font) + this->size);
HXDLIN( 346)		::String _hx_tmp1 = (_hx_tmp + ::Std_obj::string(this->bold));
HXDLIN( 346)		return (this->_hx___cacheKey = (_hx_tmp1 + ::Std_obj::string(this->italic)));
            	}
...
::String TextFormat_obj::set_font(::String value){
            	HX_STACKFRAME(&_hx_pos_c5f39c48023aa9de_350_set_font)
HXLINE( 351)		if ((this->font != value)) {
HXLINE( 353)			this->font = value;
HXLINE( 354)			this->_hx___toCacheKey();
            		}
HXLINE( 356)		return this->font;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(TextFormat_obj,set_font,return )
 ...
 ::Dynamic TextFormat_obj::set_size( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_c5f39c48023aa9de_360_set_size)
HXLINE( 361)		if (::hx::IsNotEq( this->size,value )) {
HXLINE( 363)			this->size = value;
HXLINE( 364)			this->_hx___toCacheKey();
            		}
HXLINE( 366)		return this->size;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(TextFormat_obj,set_size,return )
 ...
 ::Dynamic TextFormat_obj::set_bold( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_c5f39c48023aa9de_370_set_bold)
HXLINE( 371)		if (::hx::IsNotEq( this->bold,value )) {
HXLINE( 373)			this->bold = value;
HXLINE( 374)			this->_hx___toCacheKey();
            		}
HXLINE( 376)		return this->bold;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(TextFormat_obj,set_bold,return )
 ...
 ::Dynamic TextFormat_obj::set_italic( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_c5f39c48023aa9de_380_set_italic)
HXLINE( 381)		if (::hx::IsNotEq( this->italic,value )) {
HXLINE( 383)			this->italic = value;
HXLINE( 384)			this->_hx___toCacheKey();
            		}
HXLINE( 386)		return this->italic;
            	}
...
::hx::Val TextFormat_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 13:
		...
		if (HX_FIELD_EQ(inName,"strikethrough") ) { strikethrough=inValue.Cast<  ::Dynamic >(); return inValue; }
	}
...
static ::hx::StorageInfo TextFormat_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(TextFormat_obj,strikethrough),HX_("strikethrough",53,2c,d8,77)},
...
{
{
            	HX_STACKFRAME(&_hx_pos_c5f39c48023aa9de_58_boot)
HXDLIN(  58)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)
