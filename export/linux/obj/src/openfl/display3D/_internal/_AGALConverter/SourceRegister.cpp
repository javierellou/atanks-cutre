...
HX_DEFINE_STACK_FRAME(_hx_pos_6326831c4b7b616c_1035_new,"openfl.display3D._internal._AGALConverter.SourceRegister","new",0xa0d15d23,"openfl.display3D._internal._AGALConverter.SourceRegister.new","openfl/display3D/_internal/AGALConverter.hx",1035,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_6326831c4b7b616c_1053_toGLSL,"openfl.display3D._internal._AGALConverter.SourceRegister","toGLSL",0x906ee816,"openfl.display3D._internal._AGALConverter.SourceRegister.toGLSL","openfl/display3D/_internal/AGALConverter.hx",1053,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_6326831c4b7b616c_1038_parse,"openfl.display3D._internal._AGALConverter.SourceRegister","parse",0xa1e213b6,"openfl.display3D._internal._AGALConverter.SourceRegister.parse","openfl/display3D/_internal/AGALConverter.hx",1038,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_6326831c4b7b616c_1023_boot,"openfl.display3D._internal._AGALConverter.SourceRegister","boot",0x0e79220f,"openfl.display3D._internal._AGALConverter.SourceRegister.boot","openfl/display3D/_internal/AGALConverter.hx",1023,0x4de1651d)
namespace openfl{
namespace display3D{
namespace _internal{
...
void SourceRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_6326831c4b7b616c_1035_new)
            	}
...
::String SourceRegister_obj::toGLSL(::hx::Null< bool >  __o_emitSwizzle,::hx::Null< int >  __o_offset){
            	...
            	HX_STACKFRAME(&_hx_pos_6326831c4b7b616c_1053_toGLSL)
HXLINE(1054)		if ((this->type == 3)) {
HXLINE(1056)			if (::hx::IsPointerEq( this->programType,::openfl::display3D::_internal::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
HXLINE(1056)				return HX_("gl_Position",63,0d,2a,e5);
            			}
            			else {
HXLINE(1056)				return HX_("gl_FragColor",d7,68,e4,21);
            			}
            		}
HXLINE(1059)		bool fullxyzw;
HXDLIN(1059)		if ((this->s == 228)) {
HXLINE(1059)			fullxyzw = (this->sourceMask == 15);
            		}
            		else {
HXLINE(1059)			fullxyzw = false;
            		}
HXLINE(1060)		::String swizzle = HX_("",00,00,00,00);
HXLINE(1062)		bool _hx_tmp;
HXDLIN(1062)		if ((this->type != 5)) {
HXLINE(1062)			_hx_tmp = !(fullxyzw);
            		}
            		else {
HXLINE(1062)			_hx_tmp = false;
            		}
HXDLIN(1062)		if (_hx_tmp) {
HXLINE(1067)			if (((this->sourceMask & 1) != 0)) {
HXLINE(1069)				switch((int)((this->s & 3))){
            					case (int)0: {
HXLINE(1072)						swizzle = (swizzle + HX_("x",78,00,00,00));
            					}
            					break;
            					case (int)1: {
HXLINE(1074)						swizzle = (swizzle + HX_("y",79,00,00,00));
            					}
            					break;
            					case (int)2: {
HXLINE(1076)						swizzle = (swizzle + HX_("z",7a,00,00,00));
            					}
            					break;
            					case (int)3: {
HXLINE(1078)						swizzle = (swizzle + HX_("w",77,00,00,00));
            					}
            					break;
            				}
            			}
HXLINE(1067)			if (((this->sourceMask & 2) != 0)) {
HXLINE(1069)				switch((int)(((this->s >> 2) & 3))){
            					case (int)0: {
HXLINE(1072)						swizzle = (swizzle + HX_("x",78,00,00,00));
            					}
            					break;
...
HXLINE(1067)			if (((this->sourceMask & 4) != 0)) {
HXLINE(1069)				switch((int)(((this->s >> 4) & 3))){
            					case (int)0: {
HXLINE(1072)						swizzle = (swizzle + HX_("x",78,00,00,00));
            					}
            					break;
...
HXLINE(1067)			if (((this->sourceMask & 8) != 0)) {
HXLINE(1069)				switch((int)(((this->s >> 6) & 3))){
            					case (int)0: {
HXLINE(1072)						swizzle = (swizzle + HX_("x",78,00,00,00));
            					}
            					break;
...
HXLINE(1084)		::String str = ::openfl::display3D::_internal::AGALConverter_obj::prefixFromType(this->type,this->programType);
HXLINE(1086)		if ((this->d == 0)) {
HXLINE(1089)			str = (str + (this->n + offset));
            		}
            		else {
HXLINE(1094)			str = (str + this->o);
HXLINE(1095)			::String indexComponent = HX_("",00,00,00,00);
HXLINE(1096)			switch((int)(this->q)){
            				case (int)0: {
HXLINE(1099)					indexComponent = HX_("x",78,00,00,00);
            				}
            				break;
            				case (int)1: {
HXLINE(1101)					indexComponent = HX_("y",79,00,00,00);
            				}
            				break;
            				case (int)2: {
HXLINE(1103)					indexComponent = HX_("z",7a,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(1105)					indexComponent = HX_("w",77,00,00,00);
            				}
            				break;
            			}
HXLINE(1107)			::String indexRegister = ::openfl::display3D::_internal::AGALConverter_obj::prefixFromType(this->itype,this->programType);
HXDLIN(1107)			::String indexRegister1 = (((indexRegister + this->n) + HX_(".",2e,00,00,00)) + indexComponent);
HXLINE(1108)			str = (str + ((((HX_("[ int(",3e,aa,07,15) + indexRegister1) + HX_(") +",74,38,1f,00)) + offset) + HX_("]",5d,00,00,00)));
            		}
HXLINE(1111)		bool _hx_tmp1;
HXDLIN(1111)		if (emitSwizzle) {
HXLINE(1111)			_hx_tmp1 = (swizzle != HX_("",00,00,00,00));
            		}
            		else {
HXLINE(1111)			_hx_tmp1 = false;
            		}
HXDLIN(1111)		if (_hx_tmp1) {
HXLINE(1113)			str = (str + (HX_(".",2e,00,00,00) + swizzle));
            		}
HXLINE(1116)		return str;
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(SourceRegister_obj,toGLSL,return )
 ...
 ::openfl::display3D::_internal::_AGALConverter::SourceRegister SourceRegister_obj::parse(::cpp::Int64 v, ::openfl::display3D::_internal::_AGALConverter::ProgramType programType,int sourceMask){
            	HX_GC_STACKFRAME(&_hx_pos_6326831c4b7b616c_1038_parse)
HXLINE(1039)		 ::openfl::display3D::_internal::_AGALConverter::SourceRegister sr =  ::openfl::display3D::_internal::_AGALConverter::SourceRegister_obj::__alloc( HX_CTX );
HXLINE(1040)		sr->programType = programType;
HXLINE(1041)		sr->d = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,63),( (::cpp::Int64)(1) )));
HXLINE(1042)		sr->q = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,48),( (::cpp::Int64)(3) )));
HXLINE(1043)		sr->itype = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,40),( (::cpp::Int64)(15) )));
HXLINE(1044)		sr->type = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,32),( (::cpp::Int64)(15) )));
HXLINE(1045)		sr->s = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,24),( (::cpp::Int64)(255) )));
HXLINE(1046)		sr->o = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,16),( (::cpp::Int64)(255) )));
HXLINE(1047)		sr->n = _hx_int64_low(_hx_int64_and(v,( (::cpp::Int64)(65535) )));
HXLINE(1048)		sr->sourceMask = sourceMask;
HXLINE(1049)		return sr;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_6326831c4b7b616c_1023_boot)
HXDLIN(1023)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)
