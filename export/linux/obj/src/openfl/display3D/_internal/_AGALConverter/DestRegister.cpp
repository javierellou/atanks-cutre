...
HX_DEFINE_STACK_FRAME(_hx_pos_6dbd7f0b2c3dcc1e_616_new,"openfl.display3D._internal._AGALConverter.DestRegister","new",0xe1484e6a,"openfl.display3D._internal._AGALConverter.DestRegister.new","openfl/display3D/_internal/AGALConverter.hx",616,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_6dbd7f0b2c3dcc1e_619_getWriteMask,"openfl.display3D._internal._AGALConverter.DestRegister","getWriteMask",0xead542ab,"openfl.display3D._internal._AGALConverter.DestRegister.getWriteMask","openfl/display3D/_internal/AGALConverter.hx",619,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_6dbd7f0b2c3dcc1e_639_toGLSL,"openfl.display3D._internal._AGALConverter.DestRegister","toGLSL",0xf912bd2f,"openfl.display3D._internal._AGALConverter.DestRegister.toGLSL","openfl/display3D/_internal/AGALConverter.hx",639,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_6dbd7f0b2c3dcc1e_629_parse,"openfl.display3D._internal._AGALConverter.DestRegister","parse",0x22ed24bd,"openfl.display3D._internal._AGALConverter.DestRegister.parse","openfl/display3D/_internal/AGALConverter.hx",629,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_6dbd7f0b2c3dcc1e_609_boot,"openfl.display3D._internal._AGALConverter.DestRegister","boot",0x36154ee8,"openfl.display3D._internal._AGALConverter.DestRegister.boot","openfl/display3D/_internal/AGALConverter.hx",609,0x4de1651d)
namespace openfl{
namespace display3D{
namespace _internal{
...
void DestRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_6dbd7f0b2c3dcc1e_616_new)
            	}
...
::String DestRegister_obj::getWriteMask(){
            	HX_STACKFRAME(&_hx_pos_6dbd7f0b2c3dcc1e_619_getWriteMask)
HXLINE( 620)		::String str = HX_(".",2e,00,00,00);
HXLINE( 621)		if (((this->mask & 1) != 0)) {
HXLINE( 621)			str = (str + HX_("x",78,00,00,00));
            		}
HXLINE( 622)		if (((this->mask & 2) != 0)) {
HXLINE( 622)			str = (str + HX_("y",79,00,00,00));
            		}
HXLINE( 623)		if (((this->mask & 4) != 0)) {
HXLINE( 623)			str = (str + HX_("z",7a,00,00,00));
            		}
HXLINE( 624)		if (((this->mask & 8) != 0)) {
HXLINE( 624)			str = (str + HX_("w",77,00,00,00));
            		}
HXLINE( 625)		return str;
            	}
...
::String DestRegister_obj::toGLSL(::hx::Null< bool >  __o_useMask){
            	...
            	HX_STACKFRAME(&_hx_pos_6dbd7f0b2c3dcc1e_639_toGLSL)
HXLINE( 640)		::String str;
HXLINE( 642)		if ((this->type == 3)) {
HXLINE( 644)			if (::hx::IsPointerEq( this->programType,::openfl::display3D::_internal::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
HXLINE( 644)				str = HX_("gl_Position",63,0d,2a,e5);
            			}
            			else {
HXLINE( 644)				str = HX_("gl_FragColor",d7,68,e4,21);
            			}
            		}
            		else {
HXLINE( 648)			::String str1 = ::openfl::display3D::_internal::AGALConverter_obj::prefixFromType(this->type,this->programType);
HXDLIN( 648)			str = (str1 + this->n);
            		}
HXLINE( 651)		bool _hx_tmp;
HXDLIN( 651)		if (useMask) {
HXLINE( 651)			_hx_tmp = (this->mask != 15);
            		}
            		else {
HXLINE( 651)			_hx_tmp = false;
            		}
HXDLIN( 651)		if (_hx_tmp) {
HXLINE( 653)			str = (str + this->getWriteMask());
            		}
HXLINE( 656)		return str;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(DestRegister_obj,toGLSL,return )
 ...
 ::openfl::display3D::_internal::_AGALConverter::DestRegister DestRegister_obj::parse(int v, ::openfl::display3D::_internal::_AGALConverter::ProgramType programType){
            	HX_GC_STACKFRAME(&_hx_pos_6dbd7f0b2c3dcc1e_629_parse)
HXLINE( 630)		 ::openfl::display3D::_internal::_AGALConverter::DestRegister dr =  ::openfl::display3D::_internal::_AGALConverter::DestRegister_obj::__alloc( HX_CTX );
HXLINE( 631)		dr->programType = programType;
HXLINE( 632)		dr->type = (::hx::UShr(v,24) & 15);
HXLINE( 633)		dr->mask = (::hx::UShr(v,16) & 15);
HXLINE( 634)		dr->n = (v & 65535);
HXLINE( 635)		return dr;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_6dbd7f0b2c3dcc1e_609_boot)
HXDLIN( 609)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)
