...
HX_DEFINE_STACK_FRAME(_hx_pos_a874bbe07b70b430_935_new,"openfl.display3D._internal._AGALConverter.SamplerRegister","new",0xc3c1dbca,"openfl.display3D._internal._AGALConverter.SamplerRegister.new","openfl/display3D/_internal/AGALConverter.hx",935,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_a874bbe07b70b430_954_toGLSL,"openfl.display3D._internal._AGALConverter.SamplerRegister","toGLSL",0x9ac3cbcf,"openfl.display3D._internal._AGALConverter.SamplerRegister.toGLSL","openfl/display3D/_internal/AGALConverter.hx",954,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_a874bbe07b70b430_960_toSamplerState,"openfl.display3D._internal._AGALConverter.SamplerRegister","toSamplerState",0xa31d9ada,"openfl.display3D._internal._AGALConverter.SamplerRegister.toSamplerState","openfl/display3D/_internal/AGALConverter.hx",960,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_a874bbe07b70b430_938_parse,"openfl.display3D._internal._AGALConverter.SamplerRegister","parse",0xc0ecca1d,"openfl.display3D._internal._AGALConverter.SamplerRegister.parse","openfl/display3D/_internal/AGALConverter.hx",938,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_a874bbe07b70b430_922_boot,"openfl.display3D._internal._AGALConverter.SamplerRegister","boot",0x7df77588,"openfl.display3D._internal._AGALConverter.SamplerRegister.boot","openfl/display3D/_internal/AGALConverter.hx",922,0x4de1651d)
namespace openfl{
namespace display3D{
namespace _internal{
...
void SamplerRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_a874bbe07b70b430_935_new)
            	}
...
::String SamplerRegister_obj::toGLSL(){
            	HX_STACKFRAME(&_hx_pos_a874bbe07b70b430_954_toGLSL)
HXLINE( 955)		::String str = ::openfl::display3D::_internal::AGALConverter_obj::prefixFromType(this->type,this->programType);
HXDLIN( 955)		::String str1 = (str + this->n);
HXLINE( 956)		return str1;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SamplerRegister_obj,toGLSL,return )
 ...
 ::openfl::display::_internal::SamplerState SamplerRegister_obj::toSamplerState(){
            	HX_GC_STACKFRAME(&_hx_pos_a874bbe07b70b430_960_toSamplerState)
HXLINE( 961)		 ::Dynamic wrap;
HXLINE( 962)		 ::Dynamic filter;
HXLINE( 963)		 ::Dynamic mipfilter;
HXLINE( 968)		switch((int)(this->f)){
            			case (int)0: {
HXLINE( 971)				filter = 5;
            			}
            			break;
...
HXLINE( 973)				filter = 4;
            			...
            			break;
            			default:{
HXLINE( 975)				HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null()));
            			}
            		}
HXLINE( 979)		switch((int)(this->m)){
            			case (int)0: {
HXLINE( 983)				mipfilter = 2;
            			}
            			break;
            			case (int)1: {
HXLINE( 986)				mipfilter = 1;
            			}
            			break;
            			case (int)2: {
HXLINE( 989)				mipfilter = 0;
            			}
            			break;
            			default:{
HXLINE( 991)				HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null()));
            			}
            		}
HXLINE( 997)		switch((int)(this->w)){
            			case (int)0: {
HXLINE(1000)				wrap = 0;
            			}
            			break;
...
HXLINE(1002)				wrap = 2;
            			...
            			break;
            			default:{
HXLINE(1004)				HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null()));
            			}
            		}
HXLINE(1007)		bool ignoreSampler = ((this->s & 4) == 4);
HXLINE(1008)		bool centroid = ((this->s & 1) == 1);
HXLINE(1009)		bool textureAlpha = (this->t == 2);
HXLINE(1012)		Float lodBias = (( (Float)(((this->b << 24) >> 24)) ) / ((Float)8.0));
HXLINE(1014)		return  ::openfl::display::_internal::SamplerState_obj::__alloc( HX_CTX ,wrap,filter,mipfilter,lodBias,ignoreSampler,centroid,textureAlpha);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SamplerRegister_obj,toSamplerState,return )
 ...
 ::openfl::display3D::_internal::_AGALConverter::SamplerRegister SamplerRegister_obj::parse(::cpp::Int64 v, ::openfl::display3D::_internal::_AGALConverter::ProgramType programType){
            	HX_GC_STACKFRAME(&_hx_pos_a874bbe07b70b430_938_parse)
HXLINE( 939)		 ::openfl::display3D::_internal::_AGALConverter::SamplerRegister sr =  ::openfl::display3D::_internal::_AGALConverter::SamplerRegister_obj::__alloc( HX_CTX );
HXLINE( 940)		sr->programType = programType;
HXLINE( 941)		sr->f = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,60),( (::cpp::Int64)(15) )));
HXLINE( 942)		sr->m = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,56),( (::cpp::Int64)(15) )));
HXLINE( 943)		sr->w = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,52),( (::cpp::Int64)(15) )));
HXLINE( 944)		sr->s = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,48),( (::cpp::Int64)(15) )));
HXLINE( 945)		sr->d = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,44),( (::cpp::Int64)(15) )));
HXLINE( 946)		sr->t = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,40),( (::cpp::Int64)(15) )));
HXLINE( 947)		sr->type = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,32),( (::cpp::Int64)(15) )));
HXLINE( 948)		sr->b = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,16),( (::cpp::Int64)(255) )));
HXLINE( 949)		sr->n = _hx_int64_low(_hx_int64_and(v,( (::cpp::Int64)(65535) )));
HXLINE( 950)		return sr;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_a874bbe07b70b430_922_boot)
HXDLIN( 922)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)
