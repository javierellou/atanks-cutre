...
HX_DEFINE_STACK_FRAME(_hx_pos_b60bca42a6d00202_892_new,"openfl.display3D._internal._AGALConverter.RegisterMapEntry","new",0x7bd740be,"openfl.display3D._internal._AGALConverter.RegisterMapEntry.new","openfl/display3D/_internal/AGALConverter.hx",892,0x4de1651d)
namespace openfl{
namespace display3D{
namespace _internal{
...
void RegisterMapEntry_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_b60bca42a6d00202_892_new)
            	}
