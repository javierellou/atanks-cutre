...
void LibrarySymbol_obj::__construct(::String id){
            	HX_STACKFRAME(&_hx_pos_281fad3e86f1efa8_620_new)
HXLINE( 621)		int colonIndex = id.indexOf(HX_(":",3a,00,00,00),null());
HXLINE( 622)		this->libraryName = id.substring(0,colonIndex);
HXLINE( 623)		this->symbolName = id.substring((colonIndex + 1),null());
HXLINE( 624)		this->library = ::lime::utils::Assets_obj::getLibrary(this->libraryName);
            	}
