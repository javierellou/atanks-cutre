...
HX_LOCAL_STACK_FRAME(_hx_pos_25766fbc3da200fe_29_add,"flixel.system.frontEnds.WatchFrontEnd","add",0xbd17f1da,"flixel.system.frontEnds.WatchFrontEnd.add","flixel/system/frontEnds/WatchFrontEnd.hx",29,0xd7ade198)
HX_LOCAL_STACK_FRAME(_hx_pos_25766fbc3da200fe_42_remove,"flixel.system.frontEnds.WatchFrontEnd","remove",0x8d8c762b,"flixel.system.frontEnds.WatchFrontEnd.remove","flixel/system/frontEnds/WatchFrontEnd.hx",42,0xd7ade198)
HX_LOCAL_STACK_FRAME(_hx_pos_25766fbc3da200fe_57_addQuick,"flixel.system.frontEnds.WatchFrontEnd","addQuick",0x8c660eb3,"flixel.system.frontEnds.WatchFrontEnd.addQuick","flixel/system/frontEnds/WatchFrontEnd.hx",57,0xd7ade198)
HX_LOCAL_STACK_FRAME(_hx_pos_25766fbc3da200fe_69_removeQuick,"flixel.system.frontEnds.WatchFrontEnd","removeQuick",0x15fb44c2,"flixel.system.frontEnds.WatchFrontEnd.removeQuick","flixel/system/frontEnds/WatchFrontEnd.hx",69,0xd7ade198)
...
HX_LOCAL_STACK_FRAME(_hx_pos_25766fbc3da200fe_101_removeExpression,"flixel.system.frontEnds.WatchFrontEnd","removeExpression",0xc4a80fa3,"flixel.system.frontEnds.WatchFrontEnd.removeExpression","flixel/system/frontEnds/WatchFrontEnd.hx",101,0xd7ade198)
HX_LOCAL_STACK_FRAME(_hx_pos_25766fbc3da200fe_108_addFunction,"flixel.system.frontEnds.WatchFrontEnd","addFunction",0xff88c312,"flixel.system.frontEnds.WatchFrontEnd.addFunction","flixel/system/frontEnds/WatchFrontEnd.hx",108,0xd7ade198)
HX_LOCAL_STACK_FRAME(_hx_pos_25766fbc3da200fe_115_removeFunction,"flixel.system.frontEnds.WatchFrontEnd","removeFunction",0x9c838063,"flixel.system.frontEnds.WatchFrontEnd.removeFunction","flixel/system/frontEnds/WatchFrontEnd.hx",115,0xd7ade198)
HX_LOCAL_STACK_FRAME(_hx_pos_25766fbc3da200fe_126_addMouse,"flixel.system.frontEnds.WatchFrontEnd","addMouse",0x3add9deb,"flixel.system.frontEnds.WatchFrontEnd.addMouse","flixel/system/frontEnds/WatchFrontEnd.hx",126,0xd7ade198)
HX_LOCAL_STACK_FRAME(_hx_pos_25766fbc3da200fe_136_removeMouse,"flixel.system.frontEnds.WatchFrontEnd","removeMouse",0xc472d3fa,"flixel.system.frontEnds.WatchFrontEnd.removeMouse","flixel/system/frontEnds/WatchFrontEnd.hx",136,0xd7ade198)
namespace flixel{
...
void WatchFrontEnd_obj::add( ::Dynamic object,::String field,::String displayName){
            	HX_STACKFRAME(&_hx_pos_25766fbc3da200fe_29_add)
            	}
...
void WatchFrontEnd_obj::remove( ::Dynamic object,::String field){
            	HX_STACKFRAME(&_hx_pos_25766fbc3da200fe_42_remove)
            	}
...
void WatchFrontEnd_obj::addQuick(::String displayName, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_25766fbc3da200fe_57_addQuick)
            	}
...
void WatchFrontEnd_obj::removeQuick(::String displayName){
            	HX_STACKFRAME(&_hx_pos_25766fbc3da200fe_69_removeQuick)
            	}
...
void WatchFrontEnd_obj::removeExpression(::String displayName){
            	HX_STACKFRAME(&_hx_pos_25766fbc3da200fe_101_removeExpression)
            	}
...
void WatchFrontEnd_obj::addFunction(::String displayName, ::Dynamic func){
            	HX_STACKFRAME(&_hx_pos_25766fbc3da200fe_108_addFunction)
            	}
...
void WatchFrontEnd_obj::removeFunction(::String displayName){
            	HX_STACKFRAME(&_hx_pos_25766fbc3da200fe_115_removeFunction)
            	}
...
void WatchFrontEnd_obj::addMouse(){
            	HX_STACKFRAME(&_hx_pos_25766fbc3da200fe_126_addMouse)
            	}
...
void WatchFrontEnd_obj::removeMouse(){
            	HX_STACKFRAME(&_hx_pos_25766fbc3da200fe_136_removeMouse)
            	}
