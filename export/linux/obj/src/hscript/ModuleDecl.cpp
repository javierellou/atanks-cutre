...
::hscript::ModuleDecl ModuleDecl_obj::DImport(::Array< ::String > path, ::Dynamic everything,::String name)
{
	return ::hx::CreateEnum< ModuleDecl_obj >(HX_("DImport",c9,a0,ca,48),1,3)->_hx_init(0,path)->_hx_init(1,everything)->_hx_init(2,name);
}
