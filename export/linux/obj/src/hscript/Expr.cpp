...
::hscript::Expr Expr_obj::ECast( ::hscript::Expr e, ::hscript::CType t)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("ECast",a4,51,39,e7),28,2)->_hx_init(0,e)->_hx_init(1,t);
}
...
::hscript::Expr Expr_obj::EForGen( ::hscript::Expr it, ::hscript::Expr e)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("EForGen",2c,33,4f,67),27,2)->_hx_init(0,it)->_hx_init(1,e);
}
...
bool Expr_obj::__GetStatic(const ::String &inName, ::Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("ECast",a4,51,39,e7)) { outValue = Expr_obj::ECast_dyn(); return true; }
	...
	if (inName==HX_("EForGen",2c,33,4f,67)) { outValue = Expr_obj::EForGen_dyn(); return true; }
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Expr_obj,ECast,return)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Expr_obj,EForGen,return)
